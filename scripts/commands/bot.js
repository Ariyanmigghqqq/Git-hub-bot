...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "আহ শুনা আমার তোমাকে  উম্মাহ😇😘",
          "কি গো সোনা আমাকে ডাকছ কেনো",
          "বার বার আমাকে ডাকস কেন😡",
          "আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো হেনা,হেমা,রিয়া,রিপা,সানজিদা,শরিফা,খাদিজা,জান্নাতি,সবাই আমার বস ইয়ামিন এর বুকে আসো আমার বস ইয়ামিন এর মন অনেক বড় সকল মেয়েদের জন্য জায়গা হয়🥱",
